<template>
  <div data-spy="scroll" data-target="#navbar-example3" data-offset="86" data-scroll-animation="true" class="doc">
    <div id="preloader">
        <div id="ctn-preloader" class="ctn-preloader">
            <div class="round_spinner">
                ...
                <div class="text">
                    ...
                    <h4><span>НП БКАД</span></h4>
                </div>
            </div>
            <h2 class="head">Консультационный центр</h2>
            <p></p>
        </div>
    </div>
    <div class="body_wrapper">
                    ...
                    <ul class="navbar-nav menu ml-auto">
                        <li class="nav-item dropdown submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a href="index.html" class="nav-link">Cool Template</a></li>
        ...
        <div class="mobile_main_menu" id="sticky" style="background-color:black;">
            <div class="container">
                <div class="mobile_menu_left">
                    <button type="button" class="navbar-toggler mobile_menu_btn">
                        <span class="menu_toggle ">
                            <span class="hamburger" style="color:black !important;">
                                <span></span>
                                <span></span>
                                <span></span>
                            </span>
                        ...
                        <li class="nav-item dropdown submenu active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item dropdown submenu active">
                                    ...
                                    <i class="arrow_carrot-down_alt2 mobile_dropdown_icon"></i>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="layouts.html" class="nav-link active">Both Sidebar</a></li>
                                ...
                                <li class="nav-item dropdown submenu">
                                    <a href="#" class="nav-link">Others Pages</a>
                                    <i class="arrow_carrot-down_alt2 mobile_dropdown_icon"></i>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="code.html" class="nav-link">Code</a></li>
                                        <li class="nav-item"><a href="image.html" class="nav-link">Image</a></li>
                        ...
                        <div class="scroll">
                            <ul class="list-unstyled nav-sidebar">
                              <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <router-link to="/new_question" class="nav-link"><img src="img/side-nav/chat1.png" alt="">Задать вопрос</router-link>
                                </li>
                            </ul>
                        </div>
                    </aside>
            ...
            <div class="container custom_container">
                <form action="#" class="banner_search_form banner_search_form_two">
                    <div class="input-group">
                        <input type="search" class="form-control" placeholder="Press / key to focus search">
                        <div class="input-group-append">
                            <select class="custom-select" id="inlineFormCustomSelect">
                                <option selected>All Category</option>
                                <option value="1">Doc Archive</option>
                                <option value="2">Doc List</option>
                                <option value="3">Docly</option>
                            </select>
                        </div>
        ...
        <section class="page_breadcrumb">
            <div class="container custom_container">
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <a href="#" class="date"><i class="icon_clock_alt"></i>Последнее обновление {{last_update.created_at}}</a>
                    </div>
                </div>
            </div>
        </section>
