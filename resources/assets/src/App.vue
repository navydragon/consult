...
<style src="@/vendor/styles/docly/style.css"></style>
<style src="@/vendor/styles/docly/responsive.css"></style>
-->
<script>
export default {
  name: 'app',
  metaInfo: {
    title: 'Index',
    titleTemplate: 'Консультационный центр'
  },
  updated () {
 ...
 (function ($) {
     ...
     /*============= preloader js css =============*/
     var cites = [];
     cites[0] = "We design Docbuzz for the readers, optimizing not for page views or engagement";
     cites[1] = "Docbuzz turns out that context is a key part of learning.";
     cites[2] = "You can create any type of product documentation with Docbuzz";
